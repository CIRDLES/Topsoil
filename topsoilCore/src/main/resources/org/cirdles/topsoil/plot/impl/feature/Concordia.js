...
plot.updateConcordia = function() {
    if (plot.concordiaVisible) {
        ...
        //     }
        // } else if ((plot.getProperty('U235') != null && !isNaN(plot.getProperty('U235'))) && plot.lambda.U235 !== plot.getProperty("U235")) {
        //     plot.lambda.U235 = plot.getProperty("U235");
        //     console.log()
        // }
        //
        ...
        //     }
        // } else if ((plot.getProperty('U238') != null && !isNaN(plot.getProperty('U238'))) && plot.lambda.U238 !== plot.getProperty("U238")) {
        //
        //     plot.lambda.U238 = plot.getProperty("U238");
        // }
