...
public class ScatterPlotPropertiesPanel
    ...
    public ScatterPlotPropertiesPanel(Plot plot) {
        super(self -> {
            self.plot = plot;
        });
    }
    ...
    private void initialize() {
        ...
        pointFillColorPicker.setValue(
                Color.valueOf(
                        (String) plot.getProperties().get(POINT_FILL_COLOR)));

        pointFillColorPicker.valueProperty().addListener(
                ((observable, oldValue, newValue) -> {
                    ...
                    properties.put(POINT_FILL_COLOR, fillColor);
                    plot.setProperties(properties);
                }));
    }
