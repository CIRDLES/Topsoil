...
//        }
    ...
    public void updateDataValue(SpreadsheetCell cell) {
        ...
        data.setValue(row, col, (Double) cell.getItem());
    ...
    public class SpreadsheetHandler implements Observer {
        ...
        public void update( Observable o, Object arg ) {
            ...
            if (o instanceof ObservableDataTable) {
                ...
                switch (op.getType()) {
                    case INSERT_ROW:
                        spreadsheet.setGrid(addRow());
                        refreshDataCells();
                        break;
                    case DELETE_ROW:
                        spreadsheet.setGrid(removeRow());
                        refreshDataCells();
                        break;
                    case INSERT_COLUMN:
                        spreadsheet.setGrid(addColumn());
                        refreshDataCells();
                        break;
                    case DELETE_COLUMN:
                        spreadsheet.setGrid(removeColumn());
                        refreshDataCells();
                        break;
                    case SELECT_ROW:
                        row = op.getRowIndex();
