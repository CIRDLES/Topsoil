...
var spec = describe("Vector2D", function() {
   ...
   it("should have x attribute equal to 5 (accessed via . notation)", function() {
       buster.assert.equals(5, this.vector.x);
   });
   
   it("should have y attribute equal to 5 (accessed via . notation)" , function() {
       buster.assert.equals(5, this.vector.y);
   });
   
   it("should have x attribute equal to 5 (accessed via [] index)", function() {
       buster.assert.equals(5, this.vector[0]);
   });
   
   it("should have y attribute equal to 5 (accessed via [] index)" , function() {
